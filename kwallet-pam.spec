...
Source0  : https://download.kde.org/stable/plasma/5.27.2/kwallet-pam-5.27.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.2/kwallet-pam-5.27.2.tar.xz.sig
...
%prep
%setup -q -n kwallet-pam-5.27.2
cd %{_builddir}/kwallet-pam-5.27.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677598050
mkdir -p clr-build
pushd clr-build

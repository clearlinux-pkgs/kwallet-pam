...
Version  : 6.2.0
Release  : 108
URL      : https://download.kde.org/stable/plasma/6.2.0/kwallet-pam-6.2.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.2.0/kwallet-pam-6.2.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.0/kwallet-pam-6.2.0.tar.xz.sig
...
%setup -q -n kwallet-pam-6.2.0
cd %{_builddir}/kwallet-pam-6.2.0
pushd ..
cp -a kwallet-pam-6.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728580184
mkdir -p clr-build
pushd clr-build

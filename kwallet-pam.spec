...
Source0  : https://download.kde.org/stable/plasma/5.26.3/kwallet-pam-5.26.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.26.3/kwallet-pam-5.26.3.tar.xz.sig
...
%prep
%setup -q -n kwallet-pam-5.26.3
cd %{_builddir}/kwallet-pam-5.26.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667919330
mkdir -p clr-build
pushd clr-build

...
Source0  : https://download.kde.org/stable/plasma/6.0.4/kwallet-pam-6.0.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.4/kwallet-pam-6.0.4.tar.xz.sig
...
%setup -q -n kwallet-pam-6.0.4
cd %{_builddir}/kwallet-pam-6.0.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713286849
mkdir -p clr-build
pushd clr-build

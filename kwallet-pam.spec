...
Version  : 6.1.1
Release  : 101
URL      : https://download.kde.org/stable/plasma/6.1.1/kwallet-pam-6.1.1.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.1/kwallet-pam-6.1.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.1/kwallet-pam-6.1.1.tar.xz.sig
...
%setup -q -n kwallet-pam-6.1.1
cd %{_builddir}/kwallet-pam-6.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719414948
mkdir -p clr-build
pushd clr-build

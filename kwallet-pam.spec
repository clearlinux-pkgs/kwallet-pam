...
Source0  : https://download.kde.org/stable/plasma/6.3.3/kwallet-pam-6.3.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.3/kwallet-pam-6.3.3.tar.xz.sig
...
%setup -q -n kwallet-pam-6.3.3
cd %{_builddir}/kwallet-pam-6.3.3
pushd ..
cp -a kwallet-pam-6.3.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742432636
mkdir -p clr-build
pushd clr-build

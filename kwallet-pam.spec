...
Source0  : https://download.kde.org/stable/plasma/5.27.1/kwallet-pam-5.27.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.1/kwallet-pam-5.27.1.tar.xz.sig
...
%prep
%setup -q -n kwallet-pam-5.27.1
cd %{_builddir}/kwallet-pam-5.27.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677182878
mkdir -p clr-build
pushd clr-build
